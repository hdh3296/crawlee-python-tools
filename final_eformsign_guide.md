...
| step_settings[].recipient.additional_auth.use_pincode_result | 완료 문서 열람 시에도
...
기능 구동을 위한 함수는 EformsignDocument 객체의 경우 document 함수, EformSignTemplate 객체의 경우 template 함수를 사용합니다.
...
**✅ 최종 완성**: 누락된 텍스트와 코드 가독성을 모두 개선하여 완벽하게 완성했습니다.

*생성 시간: 2025-06-18 14:15:01*